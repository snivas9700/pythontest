...
DEPLOYEDMODELRULE_EMEA = './Models_in_Use/DeployedModelRules_EMEA_2018-07-10.csv'
...
TAG_QUOTE_LIST = [
    ...
    "DomBuyerGrpID", "DomBuyerGrpName" ,"QuoteType", 'ctry_desc', 'imt_code'
]
...
TSS_COMPONENTS_TAG_LIST = [
    ...
    "CMDAprice","Cost","coverage_hours_days",
...
NORMALHANDLER_EMEA = [
    ...
    'COPQuotePriceExpectedGP','QuoteType']
...
#removed  'ecs', 'flex','p_uplift_comm', , "swma_discounted_price"
REPORTER_COLUMNS_TSS = ['CustomerNumber', 'AdjComHighPofL', 'AdjComHighPrice', 
       ...
       'PredictedQuotePrice',
       'PredictedQuotePricePofL', 'QuoteID', 'QuotedPrice',
       ...
       'warrantyperiod', "hwma_pti","ChangePeriodStopDate",
       "ParentMapping_ComponentID","ChargeStartDate","ChargeEndDate",'ctry_desc']

#delete TSS fields from hardware component list 'swma_discounted_price',
DELETE_LIST = ["TSSComponentincluded", 'TSS_AdjComHighPofL',
       ...
       'sl_onsite', 'sl_part_time', 'totalcharge', 'type', 'warranty',
       'warrantyperiod', 
       'ChangePeriodStopDate','ChargeStartDate', 'ChargeEndDate','hwma_pti',
...
"TSS_AdjComMedPofL","ParentMapping_ComponentID"]
