...
class FixedProdHandler:
    ...
    def process_EMEA(self, fixed_quotes):
        ...
        return fixed_quotes_out
    #remove process_EMEA_TSS
    def process_EMEA_TSS(self, fixed_quotes):
        """
        :param df: output pandas.df (fixed part) from FixedProdDetector
        ...
        #TSS calculation...confirm with Jerry???
        
        fixed_quotes['TSS_AdjComLowPofL'] = 0. #fixed_quotes['AdjComLowPofL']
        fixed_quotes['TSS_AdjComMedPofL'] = 0. #fixed_quotes['AdjComMedPofL']
        fixed_quotes['TSS_AdjComHighPofL'] = 0. # fixed_quotes['AdjComHighPofL']
        fixed_quotes['TSS_AdjComLowPrice'] = 0. #fixed_quotes['AdjComLowPrice']
        fixed_quotes['TSS_AdjComMedPrice'] = 0. #fixed_quotes['AdjComMedPrice']
        fixed_quotes['TSS_AdjComHighPrice'] =0. # fixed_quotes['AdjComHighPrice']
        fixed_quotes['TSS_OptimalPricePofL'] =0. # fixed_quotes['OptimalPricePofL']
        fixed_quotes['TSS_OptimalPrice'] = 0. #fixed_quotes['OptimalPrice']
        fixed_quotes['TSS_OptimalPriceWinProb'] =0. # fixed_quotes['OptimalPriceWinProb']
        fixed_quotes['TSS_OptimalPriceGP'] = 0. #fixed_quotes['OptimalPriceGP']
        fixed_quotes['TSS_OptimalPriceExpectedGP'] = 0. #fixed_quotes['OptimalPriceExpectedGP']
        fixed_quotes['TSS_OptimalPriceIntervalLow'] = 0. #fixed_quotes['OptimalPriceIntervalLow']
        fixed_quotes['TSS_OptimalPriceIntervalHigh'] = 0. #fixed_quotes['OptimalPriceIntervalHigh']
        #fixed_quotes['TSS_DealBotLineSpreadOptimalPrice'] = fixed_quotes['DealBotLineSpreadOptimalPrice']
        
        fixed_quotes_out = copy.deepcopy(fixed_quotes)
        fixed_quotes_out.to_csv('./output_results/Fixed_EMEA_TSS_Output.csv')
