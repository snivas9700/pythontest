...
def spread_optimal_price(quote_df, tot_deal_stats):
    ...
    tots['bot_OP'] = tots['bot_OP'].mask(tots.bot_OP < tots.value_score,
                                             tots.value_score) #modified by BB on June 19th, 2018 so quote level bottom line optimal price will not be lower than value score 
