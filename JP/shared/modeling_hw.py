...
from JP.shared.modeling_utils import calc_quant_op, calc_win_prob, opt_price_ci, bound_op
from JP.shared.utils import timeit
from JP.modeling.modeling_main import apply_lme #added by Bonnie on May 30th, 2018


@timeit
def run_lme_model(mod, test_data, label='TESTING'):
    test_ = test_data.loc[:, mod.field_types.keys()]
    test_.loc[:,'winloss'] = 1  # assume value scores are all win bids #added by BB on May 30th, 2018
