...
#        print('start = ',start,' finish = ',finish,' d = ', d ,' l = ', l, ' m = ', m, ' h = ', h)

#        if d < 1e-10:
#            print('optimization searching failed in calc_quant_op:')
#            print('l,m,h = ',l,' ',m,' ',h)
...
#            finish = h + (h - m) / 5.0
#            d = (finish - start) / slices
#            print('readjusting start = ',start, ' finish = ',finish)
