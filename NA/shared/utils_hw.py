...
from NA.shared.modeling_hw import calc_mf_opt
from NA.shared.modeling_utils import calc_quant_op, calc_win_prob, opt_price_ci, price_adj
...
def build_tot_stats(comp_out):
    ...
    stats = stats.reset_index() # force the quoteid from index to column
