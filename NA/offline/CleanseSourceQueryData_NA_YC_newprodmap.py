"""
    ...
    Last update:    10 Oct 2017 by Bonnie Bao
...
data_path = '~/Box Sync/Cognitive Pricing/COPRA_HW/WorkStreams/NA_Pricing/Data/Sample_data/YuxiTestNA_newprodmap/'
...
file_in = 'NA_trainingset_raw_mapped_bundled_YC_011118.csv'
...
print('     ', file_in)
InputData = pd.read_csv(data_path + file_in, low_memory=False,lineterminator='\n').fillna('') # add lineterminator = '\n', Yuxi 12/16/17
...
OutputData['ChannelID'] = InputData['QT_CHANNELTYPE']  # New Field Edit field name YC 11/03/17


OutputData['CustomerNumber'] = InputData['QT_CUSTOMERNB_CMR'].str.strip()  # remove blanks in text
OutputData['CRMSectorName'] = InputData['QTC_CRMSECTORNAME'].str.strip()  # remove blanks in text
OutputData['CRMIndustryName'] = InputData['QTC_CRMINDUSTRYNAME'].str.strip() # remove blanks in text
...
OutputData['WinLoss'] = (InputData['COMW_WIN_IND'] == 'Y') * 1  # wins should be given a "1" value
...
OutputData['Year'] = InputData['QT_APPROVALDATE'].astype(str).str[:4] # Edited by YC
...
OutputData['Indirect(1/0)'] = (OutputData['ChannelID'] == 'I') * 1  # edited by YC 11/7/17
